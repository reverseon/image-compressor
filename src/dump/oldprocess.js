...
img_input.onload = function() {
    ...
    for (let i = 0; i < 3; i++) {
        rgbaDst.push_back(arrToMat(compressChannel(matToArr(rgbaSrc.get(i)), 50)));
    }
    ...
    // rgbaDst.push_back(zeroMat);
    // rgbaDst.push_back(arrToMat(compressChannel(matToArr(rgbaSrc.get(2)), 1)));
    // rgbaDst.push_back(rgbaSrc.get(2))
